...
import styled from 'styled-components'; //Assuming we have installed styled-components
...
import { ChainScanner, isChainTestnet } from './path-to-file'; //Assuming we have a file named ChainScanner, isChainTestnet
import { ToastSeverity } from './path-to-file'; //Assuming we have a file named ToastSeverity
...
const fetchAddressForChain = (chainId, tokenType) => {
  console.log(chainId, tokenType);
};
    ...
    <div>
      <DashboardLayoutStyled className='burnpage'>
        ...
        >
          ...
          <BurnStatsContainer {...props} />
        </div>
      </DashboardLayoutStyled>
      <TransactionTableStyled {...props} />
      <ChainSelector {...props} />
      <AppToast {...props} />
    </div>
  );
